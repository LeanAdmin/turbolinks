...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var PendingAction = (function () {
        ...
        PendingAction.prototype.resolve = function (value) {
            if (!this.pending)
                return;
            this._resolve(value);
            this.resolved = true;
        ...
        PendingAction.prototype.reject = function (reason) {
            if (!this.pending)
                return;
            this._reject(reason);
            this.rejected = true;
        ...
        PendingAction.prototype.then = function () {
            var args = [];
            for (var _i = 0; _i < arguments.length; _i++) {
                args[_i] = arguments[_i];
            }
            var _a;
            return (_a = this.promise).then.apply(_a, args);
        };
        PendingAction.prototype.catch = function () {
            var args = [];
            for (var _i = 0; _i < arguments.length; _i++) {
                args[_i] = arguments[_i];
            }
            var _a;
            return (_a = this.promise).catch.apply(_a, args);
        };
        ...
        Visit.prototype.loadCachedSnapshot = function () {
            ...
            if (snapshot) {
                ...
                this.render(function () {
                    ...
                    if (window.Turbolinks.pendingScripts && window.Turbolinks.pendingScripts.length) {
                        window.Turbolinks.loadedAllScripts.then(function () { return finish(); });
                    }
                    else {
                        finish();
                    }
            ...
            if (request && response) {
                this.render(function () {
                    ...
                    if (request.failed) {
                        ...
                        if (window.Turbolinks.pendingScripts && window.Turbolinks.pendingScripts.length) {
                            window.Turbolinks.loadedAllScripts.then(function () { return finish_1(); });
                        }
                        else {
                            finish_1();
                        }
